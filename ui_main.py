...
"border-radius: 7px;")
        ...
        self.verticalLayout.setContentsMargins(12, 12, 10, 12)
        self.labe_current_balance = QLabel(self.balance_frame)
        self.labe_current_balance.setObjectName(u"labe_current_balance")
        self.labe_current_balance.setStyleSheet(u"color: white;\n"
"font-weight: bold;\n"
"font-size: 20pt;\n"
"background-color: none;\n"
"border: none;")

        self.verticalLayout.addWidget(self.labe_current_balance)
...
"border: none;\n"
"padding-top: 10px;")
        self.icon_down_arrow.setPixmap(QPixmap(u":/icon/icons/call_received_white_24dp.svg"))
...
"border: none;")
        ...
        self.icon_grocerires = QLabel(self.categories_frame)
        self.icon_grocerires.setObjectName(u"icon_grocerires")
        self.icon_grocerires.setMaximumSize(QSize(24, 16777215))
        self.icon_grocerires.setStyleSheet(u"background-color: none;\n"
"border: none;")
        self.icon_grocerires.setPixmap(QPixmap(u":/icon/icons/local_grocery_store_white_24dp.svg"))

        self.horizontalLayout_3.addWidget(self.icon_grocerires)
...
"border: none;")
        ...
        self.horizontalLayout_4.addWidget(self.label_entertainment)
...
"border: none;")
        ...
        self.horizontalLayout_4.addWidget(self.balance_entertainment)
...
"}")
        ...
        self.tableView.horizontalHeader().setDefaultSectionSize(139)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.labe_current_balance.setText(QCoreApplication.translate("MainWindow", u"Current Balance", None))
        ...
        self.label_expense_tracker.setText(QCoreApplication.translate("MainWindow", u"Expense canegories", None))
        self.icon_grocerires.setText("")
        self.label_groceries.setText(QCoreApplication.translate("MainWindow", u"Groceries", None))
        self.balance_groceries.setText(QCoreApplication.translate("MainWindow", u"$1200", None))
        self.icon_entertainment.setText("")
        self.label_entertainment.setText(QCoreApplication.translate("MainWindow", u"Entertaiment", None))
        self.balance_entertainment.setText(QCoreApplication.translate("MainWindow", u"$1200", None))
        self.icon_auto.setText("")
        self.label_auto.setText(QCoreApplication.translate("MainWindow", u"Auto", None))
        self.balance_auto.setText(QCoreApplication.translate("MainWindow", u"$1200", None))
        self.icon_other.setText("")
        self.label_other.setText(QCoreApplication.translate("MainWindow", u"Other", None))
        self.balance_other.setText(QCoreApplication.translate("MainWindow", u"$1200", None))
